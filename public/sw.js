const CACHE='dlr-secure-super-senior-v9',FILES=['/','/index.html','/app.js','/style.css','/logo.png','/favicon.png','/apple-touch-icon.png','/manifest.webmanifest','/icon-finals-192.png','/icon-finals-512.png','/icon-finals-maskable.png'];
